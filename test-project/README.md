...
1. Download the latest theme source from the git repo.
...
6. Copy `.env.example` file and create duplicate.

        .env.example .env


7. Fill the database details `DB_DATABASE` in `.env` file.


8. The below command will create tables into database using Laravel migration.
